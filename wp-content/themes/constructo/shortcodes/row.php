<div class="submit-wrapper">
    ...
    <div class="form-group last">
        <label for="hasContent">Content wrapper</label>
        <select id="hasContent">
            <option value="true">On</option>
            <option value="false">Off</option>
            <option value="inside">Inside content wrapper</option>
        </select>
        <p>Changes where the <strong>.container</strong> element is called.</p>
    </div>
...
function anps_getValue() { 
    ...
    hasContent = document.getElementById('hasContent').value;

    window.parent.send_to_editor('[vc_row font_color="' + fontColor + '" el_class="' + elClass + '" id="' + id + '" has_content="' + hasContent + '"][/vc_row]');
}
