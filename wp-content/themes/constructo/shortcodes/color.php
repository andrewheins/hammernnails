<div class="submit-wrapper">
    ...
    <div class="form-group">
        <label for="content">Color Text</label>
        <input type="text" id="content">
        <p>Text that will have the specified color.</p>
    </div>
    ...
    <div class="form-group">
        ...
        <p>Can be set to any color and will overwrite the style attribute. The color needs to be added as a HEX value (ie. #000).</p>
    </div>
...
function anps_getValue() { 
    ...
    window.parent.send_to_editor('[color style="' + style + '" custom="' + customColor + '"]' + content + '[/color]');
}
