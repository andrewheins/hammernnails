<div class="submit-wrapper">
    ...
    <div class="form-group">
        ...
        <p>YouTube video ID, like keDneypw3HY (<a href="https://www.youtube.com/watch?v=keDneypw3HY">https://www.youtube.com/watch?v=keDneypw3HY</a>)</p>
    </div>
...
function anps_getValue() { 
    ...
    window.parent.send_to_editor('[youtube]' + id + '[/youtube]');
}
