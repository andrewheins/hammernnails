<div class="submit-wrapper">
    <div class="form-group">
        <label for="number">Number of portfolio posts</label>
        <input type="text" id="number">
        <p>The number of posts to be displayed.</p>
    </div>

    <div class="form-group">
        <label for="id">Category ID</label>
        <input type="text" id="id">
        <p>The category from which the posts will be displayed.</p>
    </div>
...
function anps_getValue() { 
    ...
    window.parent.send_to_editor('[recent_portfolio number="' + number + '" category="' + id + '"]');
}
