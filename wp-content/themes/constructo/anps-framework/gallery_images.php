...
class Gallery_images {
    ...
    function gallery_images_box() {
                                    ...
                                    if ( $attachments )
                                            foreach ( $attachments as $attachment_id ) {
                                                    echo '<li class="image" data-attachment_id="' . $attachment_id . '">
                                                            ...
                                                            <ul class="actions">
                                                                    <li><a href="#" class="delete" title="' . __( 'Delete image', 'constructo' ) . '">' . __( 'Delete', 'constructo' ) . '</a></li>
                                                            </ul>
                                                    </li>';
                                            }
                            ?>
            ...
            <p class="add_product_images hide-if-no-js">
                    <a href="#"><?php _e( 'Add gallery images', 'constructo' ); ?></a>
            </p>
                    ...
                    jQuery(document).ready(function($){
                            ...
                            jQuery('.add_product_images').on( 'click', 'a', function( event ) {
                                    ...
                                    product_gallery_frame = wp.media.frames.downloadable_file = wp.media({
                                            ...
                                            title: '<?php _e( 'Add Images to Gallery', 'constructo' ); ?>',
                                            button: {
                                                    text: '<?php _e( 'Add to gallery', 'constructo' ); ?>',
                                            },
                                            multiple: true
                                    });
                                                    ...
                                                    if ( attachment.id ) {
                                                            ...
                                                            $product_images.append('\
                                                                    <li class="image" data-attachment_id="' + attachment.id + '"">\
                                                                            ...
                                                                            <ul class="actions">\
                                                                                    <li><a href="#" class="delete" title="<?php _e( 'Delete image', 'constructo' ); ?>"><?php _e( 'Delete', 'constructo' ); ?></a></li>\
                                                                            </ul>\
                                                                    </li>');
                                                    }
    ...
    function image_meta() {
        ...
        foreach($page as $item) {
            add_meta_box( 'gallery_images', __( 'Gallery images', 'constructo' ), array(&$this,'gallery_images_box'), $item,'side');
        }
    }
