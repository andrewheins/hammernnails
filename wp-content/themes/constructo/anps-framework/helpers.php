...
if( !function_exists('anps_get_header') ) {
    function anps_get_header() {
        ...
        if (($anps_menu_type == '1' || (isset($page_heading_full) && $page_heading_full!=''))
            ...
            <div class="<?php echo esc_attr($transparent_class);?>top-bar<?php echo $hide_topmenu; ?>"><?php anps_get_top_bar(); ?></div>
        <?php endif;
        //topmenu
        if ($anps_menu_type != '1'
                && ((anps_get_option('', '', 'topmenu_style') != '3' && isset($top_bar_site) && $top_bar_site != '1')
            ...
            <div class="top-bar<?php echo $hide_topmenu; ?>"><?php anps_get_top_bar(); ?></div>
        <?php endif;
...
function anps_get_site_header_center() {
    ...
    <div class="nav-bar-wrapper nav-bar-wrapper-right">
        ...
        <?php if( anps_get_option('', '1', 'search_icon') != '' || anps_get_option('', '1', 'search_icon_mobile') != '' ):
          ...
          ?>
        <div class="site-search-toggle<?php echo $search_class; ?>">
...
if (!function_exists('widebox_posted_on')) :
    function widebox_posted_on() {
        printf(__('<span class="%1$s">Posted on</span> %2$s <span class="meta-sep">by</span> %3$s', 'constructo'), 'meta-prep meta-prep-author', sprintf('<a href="%1$s" title="%2$s" rel="bookmark"><span class="entry-date">%3$s</span></a>', get_permalink(), esc_attr(get_the_time()), get_the_date()
                ), sprintf('<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>', get_author_posts_url(get_the_author_meta('ID')), sprintf(esc_attr__('View all posts by %s', 'constructo'), get_the_author()), get_the_author()
                )
        );
    }
endif;
