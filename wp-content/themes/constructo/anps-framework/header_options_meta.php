...
function anps_header_options_add_custom_box() {
    add_meta_box('anps_header_options_meta', esc_html__('Header options', 'constructo'), 'anps_display_meta_box_header_options', 'page', 'side', 'core'); 
    add_meta_box('anps_spacing_options_meta', esc_html__('Spacing options', 'constructo'), 'anps_display_meta_box_spacing_options', 'page', 'side', 'core');       
}
...
function anps_display_meta_box_header_options($post) {
    ...
    $select_array = array(esc_html__('Default', 'constructo'), esc_html__('Off', 'constructo'), esc_html__('On', 'constructo'));
    $data = '';
    $data .= '<div class="inside">';
    $data .= '<p>';
    $data .= '<label for="anps_header_options_top_bar">';
    $data .= '<strong>'.esc_html__('Top bar', 'constructo').'</strong>';
    $data .= '</label>';
    $data .= '</p>';
    $data .= '<p>';
    ...
    $data .= '<strong>'.esc_html__('Above menu', 'constructo').'</strong>';
    $data .= '</label>';
    $data .= '</p>';
    $data .= '<p>';
...
function anps_display_meta_box_spacing_options($post) {
    ...
    $data .= esc_html__('Remove Header Margin', 'constructo');
    $data .= '</label>';
    $data .= '</li>';
    $data .= '<li>';
    $data .= '<label class="selectit">';
    ...
    $data .= esc_html__('Remove Footer Margin', 'constructo');
    $data .= '</label>';
    $data .= '</li>';
    $data .= '</ul>';
    echo wp_kses($data, array(
