    ...
    function widget($args, $instance) {
        ...
        <?php if($icon != 'fa-'): ?>
            <?php if (strpos($icon, 'anps-') !== false): ?>
                <span class="fa" <?php echo esc_attr($icon);?>"<?php if($icon_color!=''):?> style="color: <?php echo esc_attr($icon_color);?>"<?php endif; ?>><?php echo file_get_contents(get_template_directory_uri() . '/images/construction-icons/' . str_replace('anps-icon-', '', $icon) . '.svg'); ?></span>
            <?php else: ?>
